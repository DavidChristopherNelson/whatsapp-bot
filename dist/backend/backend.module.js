...
const platform_client_service_1 = require("./platform-client.service");
let BackendModule = class BackendModule {
};
exports.BackendModule = BackendModule;
exports.BackendModule = BackendModule = __decorate([
    (0, common_1.Module)({
        providers: [platform_client_service_1.PlatformClientService],
        exports: [platform_client_service_1.PlatformClientService],
    })
], BackendModule);
